...
<!--								<img src="images/R.logo.png"/>-->
                                <a href="bin/lib/espace_0.1.tar.gz" class="button" target="_blank">Download</a>
                                <div>
                                    <h2>ESPACE</h2>
                                    <span style="text-align: justify;">Extended Sparse PArtial Correlation Estimation method</span>
                                    <p style="text-align: justify;">ESPACE is an R package to construct gene regulatory networks using hub gene information.</p>
                            ...
                            <!-- entry 2-->
                            <div class="item-entry">
                                <a href="http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0106319" class="button" target="_blank">Visit web</a>
                                <!--                                <img src="images/R.logo.png"/>-->
                                <div>
                                    <h2>ENA</h2>
                                    <span style="text-align: justify;">Ensemble-Based Network Aggregation</span>
                                    <p style="text-align: justify;">ENA is an ensemble-based network aggregation method that can aggregate networks produced by various reconstruction methods into a single network that is more accurate than the network inferred by any individual method.</p>
...
<!--                                    <a href="http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0106319" class="button" target="_blank">Visit site</a>-->
							...
							<div class="item-entry">
								...
								<div>
									<h2>GeneNet</h2>
									<p style="text-align: justify;">GeneNet is an R package for learning high-dimensional dependency networks from genomic data (e.g. gene association networks). The current version of GeneNet also allows users to assign putative directions to edges in the network.</p>
...
<!--									<a href="http://strimmerlab.org/software/genenet/" class="button" target="_blank">Visit site</a>-->
                            ...
                            <!-- entry 4-->
							<div class="item-entry">
                                <a href="https://www.rdocumentation.org/packages/CDLasso/versions/1.1" class="button" target="_blank">Visit web</a>
                                <!--								<img src="images/R.logo.png"/>-->
								<div>
									<h2>CDLasso</h2>
                                    <span style="text-align: justify;">Coordinate Descent Algorithms for Lasso Penalized L1, L2, and Logistic Regression</span>
									<p style="text-align: justify;">Coordinate Descent Algorithms for Lasso Penalized Regression.</p>
...
<!--								<img src="images/matlab.logo.gif">-->
								<div>
									...
									<p style="text-align: justify;">Graphical lasso estimates a sparse inverse covariance matrix using a lasso (L1) penalty. It can be used for estimating a sparse undirected graph. </p>
...
<!--									<a href="https://sites.google.com/site/xiujunzhangcsb/software/cmi2ni" class="button" target="_blank">Visit site</a>-->
							...
							<!-- entry 8-->
							<div class="item-entry">
                                <a href="https://cran.r-project.org/web/packages/space/index.html" class="button" target="_blank">Visit web</a>
<!--								<img src="images/R.logo.png"/>-->
								<div>
									<h2>SPACE</h2>
                                    <span style="text-align: justify;">Space PArtial Correlation Estimation</span>
									<p style="text-align: justify;">Partial correlation estimation with joint sparse regression model.</p>
...
<!--									<a href="https://cran.r-project.org/web/packages/space/index.html" class="button" target="_blank">Visit site</a>-->
                            ...
                            <!-- entry 9-->
                            <div class="item-entry">
                                <a href="https://cran.r-project.org/web/packages/BayesianGLasso/index.html" class="button" target="_blank">Visit web</a>
                                <!--								<img src="images/R.logo.png"/>-->
                                <div>
                                    <h2>BayesianGLASSO</h2>
                                    <span style="text-align: justify;">Bayesian Graphical Lasso</span>
                                    <p style="text-align: justify;">Implements a data-augmented block Gibbs sampler for simulating the posterior distribution of concentration matrices for specifying the topology and parameterization of a Gaussian Graphical Model (GGM). This sampler was originally proposed in Wang (2012).</p>
