					...
					<div class="12u">
						<section>
							...
							<div class="item-entry">
								...
								<div>
									<h2>ESPACE</h2>
									<span>Extended Sparse PArtial Correlation Estimation method</span>
									<p>ESPACE is an R package to construct gene regulatory network using hub gene information.</p>
									<span>Donghyeon Yu, et al. "Enhanced construction of gene regulatory network using hub gene information". xxx</span>
									<a href="#" class="button" target="_blank">Visit site >></a>
								</div>
							</div>
							<!-- entry 2 -->
							<div class="item-entry">
								...
								<div>
									<h2>GeneNet</h2>
									<p>GeneNet is an R package for learning high-dimensional dependency networks from genomic data (e.g. gene association networks). The current version of GeneNet also allows to assign putative directions to edges in the network.</p>
									<span>Schäfer, Juliane, and Korbinian Strimmer. "A shrinkage approach to large-scale covariance matrix estimation and implications for functional genomics." Statistical applications in genetics and molecular biology 4.1 (2005): 32.</span>
							...
							<div class="item-entry">
								...
								<div>
									<h2>CDLasso</h2>
									<span>Coordinate Descent Algorithms for Lasso Penalized L1, L2, and Logistic Regressiong</span>
									<p>Donec condimentum, urna non molestie semper, ligula enim ornare nibh, quis laoreet eros quam eget ante. . Aliquam libero. Vivamus nisl nibh, iaculis vitae, viverra sit amet, ullamcorper vitae, turpis. Aliquam erat volutpat. Vestibulum dui sem, pulvinar sed, imperdiet nec, iaculis nec, leo. Fusce odio.</p>
							...
							<div class="item-entry">
								...
								<div>
									<h2>SPACE</h2>
									<span>Space PArtial Correlation Estimation</span>
									<p>Partial correlation estimation with joint sparse regression model.</p>
									<span>Peng, Jie, et al. "Partial correlation estimation by joint sparse regression models." Journal of the American Statistical Association 104.486 (2009): 735-746.</span>
						...
						<section>
							<header>
								<h2>Software for network visualization</h2>
								<span class="byline">Augue praesent a lacus at urna congue rutrum</span>
							</header>
