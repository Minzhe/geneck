...
parser$add_argument("method", type = "integer", help = "method to use to construct the gene network, should be integer [1,11].")
...
parser$add_argument("-p", "--param_2", type = "double", help = "additional parameter if the method is 8, 9 or 11.")
