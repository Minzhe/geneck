...
$hubgene_box = "<tr>
                    ...
                    <td><input type=\"text\" title=\"E.g. Gene13,Gene52,Gene199\" placeholder=\"E.g. Gene13,Gene52,Gene199\" class=\"inputbox\" name=\"hubgenes\" required> <img src='images/icon-question.png' title='E.g. Gene13,Gene52,Gene199 (Gene names must be in gene expression data file)'/></td>
                </tr>";
...
<form id="myform" action="submitjob.php" enctype="multipart/form-data" method="POST">
    <div class="text-bg">
        <table class="para-table">
            <!-- parameters -->
            <tr>
                <td><strong>Data & parameters (Required)</strong></td>
            </tr>
            <tr>
                <td colspan="3">
                    <hr/>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>< style="width:auto;height:auto;" src="images/example.png"/></p>
                                    ...
                                    <ol style="list-style-position: inside;">
                                        ...
                                        <li>The first row will be used as gene name. The rest of the row must be numeric
                                            type.
                                        </li>
                                    ...
                                    <strong style="font-size: 17px">small size:</strong><a
                                        href="data/demo_data_small.csv"><img style="width: 40px; padding-left: 15px;"
            ...
            <tr>
                ...
                ?>
                <td><input type="text" id="<?php echo $echoid ?>" min="0" maxlength=5
                           placeholder="Default: <?php echo $default; ?>" class="inputbox" name="param" required>
                    <span id='spanParamValidation' style="color:red; font-size:14px"></span>
                </td>
            </tr>
            <?php if (in_array($method_index, array('eglasso', 'espace'))) {
                echo $param_2_box;
                echo $hubgene_box;
            } ?>
            <?php if ($method_index == 'ena') {
                echo $param_2_select;
            } ?>
            <tr>
            ...
            <tr>
                <td></td>
                <td colspan="2"><p style="font-size: 12px">You will be notified through e-mail when you submit your
                        job.</p></td>
            </tr>
            <tr>
                <td><br/></td>
            ...
            <tr>
                <!-- pass method -->
                <td><label for="method"></label><input id="method" name="method" value="<?php echo $method_index; ?>" style="display: none;" type="text" /></td>
