...
<!--        <script src='https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.2/MathJax.js?config=TeX-MML-AM_CHTML'></script>-->
        ...
        <script>
            ...
            $(document).ready(function(){
                ...
                $('#alert').hide();
                var error, pageindex;
                error= "<?php if(isset($_GET['error'])) echo cleandata::clean($_GET['error']); ?>";
                pageindex="<?php if(isset($_GET['pageindex'])) echo cleandata::clean($_GET['pageindex']); ?>";
					...
					<div class="9u skel-cell-important" id="ajaxcontent">
						<section class="intro">
                            ...
                            <div id="detail-intro1">
                                ...
                                <p>
                                    <code>GeNeCK</code> provides 8 network inference methods that use distinct statistical strategies:
                            ...
                            <div id="detail-intro2">
                                ...
                                <p>
                                    ...
                                    <a data-target="#myModal-example" data-toggle="modal" style="cursor: pointer">>>> Example</a>
                                </p>
                                <div class="modal modal-wide fade in" id="myModal-example" role="dialog" style="padding-right: 13px;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            ...
                            <div class="modal modal-wide fade in" id="myModal-result" role="dialog" style="padding-right: 13px;">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
