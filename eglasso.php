        ...
        <!-- **********************************  side bar  ************************************* -->
            <div class="3u">
                ...
                <section class="sidebar" id="methods">
                    ...
                    <ul class="style1 methods">
                        <li style="cursor:pointer" id="genemethod8" class="method-active"><a href="eglasso.php">EGLASSO</a></li>
                    ...
                    <div class="text-bg">
                        <table class="para-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" min=0.001 step=0.001 class="inputbox" name="param" value=0.6 required>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" min=0 max=1 step=0.001 class="inputbox" name="param_2" value=0.8 required>
                            ...
                            <!-- *************** submit **************** -->
                            <tr>
                                <td><label for="method"></label><input id="method" name="method" value="8" style="display: none;" type="text"/></td>
